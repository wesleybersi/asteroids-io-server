...
export default class Floor {
  ...
  initialMass: number = 0;
  initialAsteroidCount: number = 0;

  //TODO Move to matrix
  walls: Map<string, Wall> = new Map(); // <row,col, Wall>
  holes: Map<string, Hole> = new Map(); // <row,col, Wall>

  asteroidOrigins = new Map<number, Set<Asteroid>>(); //index, set<Asteroid>
  ...
  updaters: Set<ItemDrop | Spikes | Projectile | Shooter | Asteroid> =
    new Set(); //Add object to this set and the object's update method gets called each frame
